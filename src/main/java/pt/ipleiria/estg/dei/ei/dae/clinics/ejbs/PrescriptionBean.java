...
public class PrescriptionBean {
    ...
    public List<Object[]> getAllPrescriptions() {
        Query query = entityManager.createQuery("SELECT p.id, p.healthcareProfessional.name, p.startDate, p.endDate FROM Prescription p");
     ...
     * @param healthProfessionalUsername Healthcare Professional Username that is creating the current Prescription
     ...
     */
    public Prescription create(String healthProfessionalUsername, String startDate, String endDate, String notes, List<BiometricDataIssue> biometricDataIssues) throws ParseException, MyEntityNotFoundException {
        HealthcareProfessional healthcareProfessional = entityManager.find(HealthcareProfessional.class, healthProfessionalUsername);
        
        if (healthcareProfessional == null)
            throw new MyEntityNotFoundException("Healthcare Professional \"" + healthProfessionalUsername + "\" does not exist");

        Prescription prescription = new Prescription(healthcareProfessional, startDate, endDate, notes, biometricDataIssues);
