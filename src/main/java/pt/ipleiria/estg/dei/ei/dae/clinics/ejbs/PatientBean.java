...
public class PatientBean {
     ...
     */
    public long create(String email, String password, String name, String gender, int healthNo, long created_byId) throws MyEntityExistsException, MyEntityNotFoundException {
     ...
     */
    public void update(long id, String email, String password, String name, String gender, int healthNo) throws MyEntityNotFoundException {
        Patient patient = findPatient(id);
